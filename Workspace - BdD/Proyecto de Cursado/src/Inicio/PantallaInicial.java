	...
	private void crearBotones() {
		...
		botonAdmin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				Object[] cuadroDeIngreso = { "Contraseña:", password };
				...
				while (!valido) {
					...
					if (option == JOptionPane.OK_OPTION) {
						...
						if (!valido)
							JOptionPane.showMessageDialog(null, "La contraseña ingresada es incorrecta.", "Contraseña Incorrecta", JOptionPane.ERROR_MESSAGE);
					}
					else
						break;
				}
